...
use Carl\Request\WithJsonAccept;
...
final class WithJsonAcceptTest extends TestCase
{
    use WithRunningServer;
    use AssertsReflectedResponse;

    #[Test]
    public function addsAcceptHeader(): void
    {
        ...
        $this->assertReflectedHeader($response, 'accept', 'application/json');
    }
}
