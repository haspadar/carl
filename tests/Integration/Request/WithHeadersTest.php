...
final class WithHeadersTest extends TestCase
{
    ...
    #[Test]
    public function sendsMultipleHeaders(): void
    {
        $request = new WithHeaders(
        ...
        $this->assertReflectedHeader($response, 'x-foo', 'Alpha');
        $this->assertReflectedHeader($response, 'x-bar', 'Beta');
    }
}
